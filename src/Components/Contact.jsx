...
const Contact = () => {
  return (
    <section id='contact' className='section pt-20 lg:pt-32'>
          <div className="container px-4 mx-auto lg:px-8 xl:max-w-6xl lg:grid lg:grid-cols-2 lg:items-stretch">

            <div className="mb-12 lg:not-first:mb-0 lg:flex lg:flex-col">
                
                <h2 className="headline-2 text-3xl lg:text-4xl lg:leading-tight font-semibold lg:max-w-[12ch]  reveal-up translate-y-20 opacity-0">
                   Contact me for collaboration
                </h2>

                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]  reveal-up translate-y-20 opacity-0">
                ...
                <div className=" flex items-center gap-2 mt-auto">
                    {
                        socialLinks.map(({href,icon},key)=>(
                            ...
                            href={href}
                            target='_blank'
                            className='w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80  reveal-up translate-y-20 opacity-0'
                            >
                               {icon}
                            </a>
                        ))
            ...
            <form 
            action="https://getform.io/f/bxoygyga"
            method='POST' 
            ...
            >
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                   <div className="mb-4">
                       <label 
                       htmlFor="name" 
                       className='label block text-zinc-200 text-sm font-normal mb-2  reveal-up translate-y-20 opacity-0'
                       >
                          Name
                       </label>
                       ...
                       className="text-field block outline-none w-full px-3 py-3 text-sm bg-zinc-800 rounded-xl ring-1 ring-inset ring-transparent transition-shadow hover:ring-zinc-50/5 focus:ring-sky-400 focus:ring-2 text-zinc-400  reveal-up translate-y-20 opacity-0" 
                       />
                    </div>  
                ...
                <div className="mb-4">
                    ...
                    placeholder='Hii'
                    required
                    className="text-field block outline-none w-ful px-3 py-3 text-sm bg-zinc-800 rounded-xl ring-1 ring-inset ring-transparent transition-shadow hover:ring-zinc-50/5 focus:ring-sky-400 focus:ring-2 text-zinc-400 w-full min-h-32 max-h-80  reveal-up translate-y-20 opacity-0"
                    >
                ...
                <button 
                type="submit" 
                className='btn btn-primary [&]:max-w-full w-full justify-center  reveal-up translate-y-20 opacity-0'>
                    Submit
                </button>
